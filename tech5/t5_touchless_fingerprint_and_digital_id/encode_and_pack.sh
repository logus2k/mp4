...
# read -p "Enter the movie file name (e.g. avengers.mp4): " input_text

# readarray -d " " -t strarr <<< "$input_text"

# input_movie_name="${strarr[0]}"
# input_movie_extension="${strarr[1]}"

input_movie_name="t5_touchless_fingerprint_and_digital_id"
input_movie_extension=".mp4"

input_movie="${input_movie_name}${input_movie_extension}"
...
packager \
  ...
  --mpd_output ${input_movie_name}.mpd
